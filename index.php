...
$bibliotheque = simplexml_load_file('trad/trad.xml');
$lang = $_SESSION['lang'];
				...
				<div class="row">
					<div class="dropdown" style="">
						<ul id="nav" class="nav">
							...
							<li class="menu-item"><a class="smoothScroll" href="page/cv.php?lang=<?php echo $_SESSION['lang'];?>" title="Resume"><i class="icon-file"></i></a></li>
							<li class="menu-item"><a class="smoothScroll" href="page/portfolio.php?lang=<?php echo $_SESSION['lang'];?>" title="Portfolio"><i class="icon-briefcase"></i></a></li>
                            <li class="menu-item">
                            <a href="/index.php?lang=en" style="z-index=101;">
	...
	<div id="headerwrap">
		<div class="container">
			<div class="row centered">
				<div class="col-lg-12">
					<h1>David Goerig</h1>
                    <h3><?php echo $_SESSION['xmllang']->comp;?></h3>
				</div><!--/.col-lg-12 -->
			</div><!--/.row -->
		</div><!--/.container -->
	</div><!--/.#headerwrap -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 col-lg-offset-1">
					<h5><?php echo $_SESSION['xmllang']->about;?></h5>
				</div>
				<div class="col-lg-6">
					<p><?php echo $_SESSION['xmllang']->pres;?></p>
				</div>
			</div><!--/.row -->
		</div><!--/.container -->
	</div><!--/ #intro -->
