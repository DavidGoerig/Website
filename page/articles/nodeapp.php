...
$bibliotheque = simplexml_load_file('../../trad/nodeapp.xml');
$lang = $_SESSION['lang'];
...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#nav">
    ...
    <div id="articlemmo">
        <div class="row">
            <img src="../../assets/img/port11.bmp" style="padding: 0;display: block;margin: 0 auto;max-height: 100%;max-width: 100%;">
        </div>
        <div class="container">
            <h5>NODE JS DASHBOARD</h5>
            <div class="col-lg-8 col-lg-offset-2">
                <h5><?php echo $_SESSION['xmllang']->pa;?></h5>
                <div class="col-lg-2">
                    <a href="https://github.com/DavidGoerig/NodeApp"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		C438.536,184.851,428.728,148.168,409.132,114.573z"/></g>
</svg></a>
