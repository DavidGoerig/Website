...
$bibliotheque = simplexml_load_file('../../trad/mybomberman.xml');
$lang = $_SESSION['lang'];
...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#nav">
				...
				<div class="row">
					<div class="dropdown">
						<ul id="nav" class="nav">
                            ...
                            <li class="menu-item">
                                <a href="mybomberman.php?lang=en" style="z-index=101;">
                                    <img src="../../assets/img/flag/en.png" alt="" width=20 height=20>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="mybomberman.php?lang=fr">
    ...
    <div id="articlemmo">
        <div class="row">
            <img src="../../assets/img/port08.bmp" style="width=180px;height = 120px;">
        </div>
        <div class="container">
            <h5>MY BOMBERMAN</h5>
