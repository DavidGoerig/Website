...
$bibliotheque = simplexml_load_file('../../trad/raytracer.xml');
$lang = $_SESSION['lang'];
	...
	<div id="articleepiena">
		<div class="container">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <div class="col-lg-2">
                    <a href="https://github.com/DavidGoerig/raytracer"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		C438.536,184.851,428.728,148.168,409.132,114.573z"/></g>
                ...
                <div class="col-lg-9">
                    <h5 class="myborder"><?php echo $_SESSION['xmllang']->pd;?></h5>
                </div>
            </div>
		</div>
