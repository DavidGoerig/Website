...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#nav">
	...
	<div id="articlesony">
        <div class="row">
            <img src="../../assets/img/port05.bmp" style="padding: 0;display: block;margin: 0 auto;max-height: 100%;max-width: 100%;">
        </div>
		<div class="container">
            ...
            <div class="row">
                <a href="../../todlfile/SONY.pdf" style="background-color: black;"><i></i> <h5><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                                                    viewBox="0 0 471.2 471.2" style="enable-background:new 0 0 471.2 471.2;" xml:space="preserve" width="30" height="30">
<g>
    <g>
...
</svg><b> <?php echo $_SESSION['xmllang']->dld;?></b></h5></a>
            </div>
		</div>
	</div>
